 ...
 *              p_img: https://m.media-amazon.com/images/I/71ShBw4g6GL._SX679_.jpg
 *              u_name: Harshini
 *              u_token: eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1X25hbWUiOiJIYXJzaGluaSIsInVfcHdkIjoiYXNkMTIzIn0.nZSZX__GNJW_nWozDJ0s2tc8GoLzeyz32VrLc9XAdpY
 */
...
//=================tags -> grouping under 'Cart'=================//
//================= GET =================//
/**
 * @swagger
 * /fetch/cartFetch:
 *  get:
 *      summary: Returns list of all Users cart
 *      tags: [Cart]
 *      responses:
 *          '200':
 *              description: List of all Users cart
 *              content:
 *                  application/json:
 *                      schema:
 *                          type: array
 ...
 * /update/cartUpdate:
 *  put:
 *      summary: "Update existing Cart by u_id"
 *      tags: [Cart]
 *      requestBody:
 *          required: true
 *          content:
 ...
 *  /delete/cartDelete:
 *     delete:
 *      summary: "Delete existing Cart by u_id"
 *      tags: [Cart]
 *      requestBody:
 *          required: true
 *          content:
